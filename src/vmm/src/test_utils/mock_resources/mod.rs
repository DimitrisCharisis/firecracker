...
pub const DEFAULT_KERNEL_IMAGE: &str = "test_pe_riscv.bin"; // TODO: Fake file, to pass compilation
#[cfg(target_arch = "x86_64")]
pub const NOISY_KERNEL_IMAGE: &str = "test_noisy_elf.bin";
#[cfg(target_arch = "aarch64")]
pub const NOISY_KERNEL_IMAGE: &str = "test_pe.bin";
#[cfg(target_arch = "riscv64")]
pub const NOISY_KERNEL_IMAGE: &str = "test_pe_riscv.bin"; // TODO: Fake file, to pass compilation
